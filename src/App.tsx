  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        {/* One setup page: targeting, resume, voice, portfolio. */}
        ...
        {/* Legacy paths fold into the consolidated pages. */}
        <Route path="/profiles" element={<Navigate to="/setup" replace />} />
        <Route path="/resume" element={<Navigate to="/setup" replace />} />
        <Route path="/voice" element={<Navigate to="/setup" replace />} />
        <Route path="/portfolio" element={<Navigate to="/setup" replace />} />
